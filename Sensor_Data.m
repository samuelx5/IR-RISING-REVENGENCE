...
function T = Sensor_Data(pipe,colorizer,profile,dev,name, align)
    ...
    if ~isempty(blobMeasurements(idx))
        ...
        p_x = 324.7;
        p_y = 248.2;
        x_coord = ((centroid(1) - p_x) * (1-distance))/f;
        y_coord = ((centroid(2) - p_y) * (1-distance))/f;
        ...
        positional = [x_end,y_end,(1-distance) - 0.3];
...
% Auto-generated by colorThresholder app on 27-Oct-2023
%------------------------------------------------------
