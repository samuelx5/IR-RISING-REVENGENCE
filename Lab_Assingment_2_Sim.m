...
% qMatrix3 = jtraj(q3,q4,steps);
% 
% figure(1)
% robot.model.plot(qMatrix,'workspace',workspace,'trail','r-') 
% pause(3);
% robot.model.plot(qMatrix2, 'workspace',workspace,'trail','r-')
% pause(3);
% robot.model.plot(qMatrix3, 'workspace',workspace,'trail','r-')
